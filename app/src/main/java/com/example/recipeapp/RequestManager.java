...
public class RequestManager {
    ...
    public void getSimilarRecipes(SimilarRecipesListener listener, int id, String number) {
        CallSimilarRecipes callSimilarRecipes = retrofit.create(CallSimilarRecipes.class);
        Call<List<SimilarRecipeResponse>> call = callSimilarRecipes.callSimilarRecipes(id, number, context.getString(R.string.api_key));
